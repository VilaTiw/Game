...
def gun_kill(stats, screen, sc, gun, inos, bullets):
    """знищення танчика інопланетянами"""
...
def inos_check(stats, screen, sc,gun, inos, bullets):
    """Перевірка проривання оборони інопланетянами (досягнення кінця екрану)"""
...
def check_high_score(stats, sc):
    """Перевірка встановлення нового рекорду"""
